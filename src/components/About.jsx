            ...
            <div class="container pt-3 pb-3 my-3">
                <div style={{ textAlign: "left" }} >
                    ...
                    <p>
                        ...
                        The website is made with ReactJS and uses Firebase. <br />
                        Purdue Bikes In Trees does not condone the theft/crime of bikes.
                    </p>
                    ...
                    <p>
                        ...
                        Mobile App: Hopefully, after the website version fully releases, I can also create an mobile app version for mobile users to more easily access. <br />
